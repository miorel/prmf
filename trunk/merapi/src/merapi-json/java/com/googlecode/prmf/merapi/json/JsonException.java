...
/**
 * Indicates there was a problem while parsing text in JSON format.
 * 
 * @author Miorel-Lucian Palii
 */
public class JsonException extends Exception {
	private static final long serialVersionUID = -7460034914311253319L;

	/**
	 * Constructs a new JSON exception with a <code>null</code> detail message.
	 */
