...
/**
 * Raised when a socket disconnects or when a connection times out.
 * 
 * @author Miorel-Lucian Palii
 */
public class DisconnectedEvent extends AbstractNetworkEvent {
	/**
	 * Constructs a disconnection event associated with the given client.
	 * 
	 * @param client
	 *            the client to associate with
	 */
	public DisconnectedEvent(SocketClient client) {
		super(client);
	}
